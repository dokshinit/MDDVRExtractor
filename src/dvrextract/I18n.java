...
public class I18n {
    ...
    public static void init(Lang lang) {
        ...
        GUI_TabAbout.x_labels = new String[]{
            ...
            "Ffmpeg v0.8.x is required for processing and transcoding (save of the audio and embedding of audio/subtitles in the video file may be unavailable in earler version)."),
            text("Страница загрузки:", "Download page:"),
            ...
            "Detailed information on installing, configuring and workflow is explained in the file <b>readme.txt</b>. The data extraction from HDD recorder is also clarified."),
            ...
            "The choice of file or directory as a data source (all the directory and subdirectories files in suitable formats are scanned and accepted for processing by selecting the directory)."),
