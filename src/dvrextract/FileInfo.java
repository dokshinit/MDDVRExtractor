...
public final class FileInfo {
    ...
    /**
     * Пропуски кадров - когда FPS меньше заявленного 
     * Для оценки работы регистратора - бывает эпизодичесик СУЩЕСТВЕННО 
     * ниже заданного (не хватает производительности?).
     */
