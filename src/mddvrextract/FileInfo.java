...
public final class FileInfo {
    ...
    /**
     * Информация о камерах содержащаяся в файле (для EXE - из инфы файла, для
     * HDD - из первого фрейма).
     */
    ...
    /**
     * Пропуски кадров. Когда FPS меньше заявленного Для оценки работы
     * регистратора - бывает эпизодичесик СУЩЕСТВЕННО ниже заданного (не хватает
     * производительности?).
     */
    public ArrayList<Skip> p_Skip;
    /**
     * Пропуски из-за нарушения структуры файла.
     */
    ...
    /**
     * Возвращает список номеров камер как строку с их перечислением через
     * запятую.
     *
    ...
    public class CamData {
         ...
         *
         * @param num Номер камеры.
         * @param offs Смещение до первого ключевого кадра.
         * @param f Распознанный первый ключевой кадр или null.
         */
    ...
    public class Skip {
        ...
        /**
         * Время пропущенного кадра.
         */
        public long time;
        /**
         * Кол-во пропущенных кадров.
         */
        public long count;
    }
    ...
    public class Error {
        ...
        /**
         * Позиция возникновения ошибки.
         */
        public long pos;
        /**
         * Кол-во пропущенных байт.
         */
        public long count;
    }
