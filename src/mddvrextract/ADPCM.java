...
public class ADPCM {
    ...
    /**
     * Возвращает значение текущего смещения во входном буфере с начала процесса
     * декодирования.
     *
     * @return Смещение.
     */
    ...
    /**
     * Возвращает значение текущего смещения в выходном буфере с начала процесса
     * декодирования.
     *
     * @return Смещение.
     */
     ...
     * декодированные данные в выходной буфер с нулевой позиции. В процессе
     * декодирования вычисляется кол-во обработанных байтов из входного буфера
     * <b>inShift</b> и кол-во записаных в выходной буфер <b>outShift</b>.
     *
     * @param inpos Начальная позиция во входном буфере.
     * @param outpos Начальная позиция в выходном буфере.
    ...
    public int HI_VOICE_Decode(int inpos, int outpos) {
        try {
            ...
            /*
             * Варианты от [codec-1] 00 00 01 02 03 04 05 07 07 07 07 07 07 07
             * 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 01 02
             * 03 04 05 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07 07
             * 07 07 07 07 07 07 00 00 01 06 Переходы 44 4E 4C 00 7D 4E 4C 00 B1
             * 4E 4C 00 19 4F 4C 00 93 4F 4C 00 07 50 4C 00 83 50 4C 00 C0 50 4C
             * 00
             */
            switch (idCodec - 1) {
                case 0x00:
    ...
    /**
     * Конвертирует фрейм с текущей позиции в выходной буфер. СОХРАННОСТЬ данных
     * во входном буфере НЕ СОБЛЮДАЕТСЯ (!).
     *
     * @return Результат выполнения операции: 0-без ошибок, иначе код ошибки.
     */
