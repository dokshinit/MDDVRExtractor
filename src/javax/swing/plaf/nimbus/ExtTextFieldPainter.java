...
final class ExtTextFieldPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor("nimbusBase", 0.032459438f, -0.6653556f, 0.55549018f, 0);
    //decodeColor("nimbusBlueGrey", -0.015872955f, -0.07995863f, 0.15294117f, 0);
    ...
    public ExtTextFieldPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
    ...
    private void paintBorderDisabled(Graphics2D g) {
        rect = decodeRect2(); // Верхняя часть рамки.
        g.setPaint(decodeGradient1(rect));
        g.fill(rect);
        rect = decodeRect3(); // Верхняя тень рамки.
        g.setPaint(decodeGradient2(rect));
        g.fill(rect);
        rect = decodeRect4(); // Левая часть рамки.
        g.setPaint(color6);
        g.fill(rect);
        rect = decodeRect5(); // Нижняя часть рамки!
        g.setPaint(color4);
        g.fill(rect);
        rect = decodeRect6(); // Правая часть рамки
        g.setPaint(color4);
        g.fill(rect);
    ...
    private Rectangle2D decodeRect5() {
        rect.setRect(decodeX(0.6666667f), //x
                decodeY(2.0f), //y
                decodeX(2.3333333f) - decodeX(0.6666667f), //width
                decodeY(2.3333333f) - decodeY(2.0f)); //height
        return rect;
    }
