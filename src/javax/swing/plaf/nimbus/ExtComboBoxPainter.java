...
public final class ExtComboBoxPainter extends AbstractRegionPainter {
    ...
    String base = "nimbusBase";
    private Color color1 = decodeColor("nimbusBlueGrey", -0.6111111f, -0.110526316f, -0.74509805f, -247);
    //
    private Color color2 = decodeColor(base, 0.032459438f, -0.5928571f, 0.2745098f, 0);
    private Color color3 = decodeColor(base, 0.032459438f, -0.590029f, 0.2235294f, 0);
    //
//    private Color color4 = decodeColor(base, 0.032459438f, -0.60996324f, 0.36470586f, 0);
//    private Color color5 = decodeColor(base, 0.040395975f, -0.60474086f, 0.33725488f, 0);
//    private Color color6 = decodeColor(base, 0.032459438f, -0.5953556f, 0.32549018f, 0);
//    private Color color7 = decodeColor(base, 0.032459438f, -0.5957143f, 0.3333333f, 0);
    private Color color4 = decodeColor(base, 0.032459438f, -0.68996324f, 0.56470586f, 0);
    private Color color5 = decodeColor(base, 0.040395975f, -0.68474086f, 0.53725488f, 0);
    private Color color6 = decodeColor(base, 0.032459438f, -0.6653556f, 0.52549018f, 0);
    private Color color7 = decodeColor(base, 0.032459438f, -0.6657143f, 0.5333333f, 0);
    //
    private Color color8 = decodeColor(base, 0.021348298f, -0.56289876f, 0.2588235f, 0);
    private Color color9 = decodeColor(base, 0.010237217f, -0.55799407f, 0.20784312f, 0);
    //
    private Color color10 = decodeColor(base, 0.021348298f, -0.59223604f, 0.35294116f, 0);
    private Color color11 = decodeColor(base, 0.02391243f, -0.5774183f, 0.32549018f, 0);
    private Color color12 = decodeColor(base, 0.021348298f, -0.56722116f, 0.3098039f, 0);
    private Color color13 = decodeColor(base, 0.021348298f, -0.567841f, 0.31764704f, 0);
    private Color color14 = decodeColor("nimbusBlueGrey", 0.0f, 0.0f, -0.22f, -176);
    private Color color15 = decodeColor(base, 0.032459438f, -0.5787523f, 0.07058823f, 0);
    private Color color16 = decodeColor(base, 0.032459438f, -0.5399696f, -0.18039218f, 0);
    private Color color17 = decodeColor(base, 0.08801502f, -0.63174605f, 0.43921566f, 0);
    private Color color18 = decodeColor(base, 0.040395975f, -0.6054113f, 0.35686272f, 0);
    private Color color19 = decodeColor(base, 0.032459438f, -0.5998577f, 0.4352941f, 0);
    private Color color20 = decodeColor(base, 5.1498413E-4f, -0.34585923f, -0.007843137f, 0);
    private Color color21 = decodeColor(base, 5.1498413E-4f, -0.095173776f, -0.25882354f, 0);
    private Color color22 = decodeColor(base, 0.004681647f, -0.6197143f, 0.43137252f, 0);
    private Color color23 = decodeColor(base, -0.0028941035f, -0.4800539f, 0.28235292f, 0);
    private Color color24 = decodeColor(base, 5.1498413E-4f, -0.43866998f, 0.24705881f, 0);
    private Color color25 = decodeColor(base, 5.1498413E-4f, -0.4625541f, 0.35686272f, 0);
    private Color color26 = decodeColor("nimbusFocus", 0.0f, 0.0f, 0.0f, 0);
    private Color color27 = decodeColor(base, 0.032459438f, -0.54616207f, -0.02352941f, 0);
    private Color color28 = decodeColor(base, 0.032459438f, -0.41349208f, -0.33725494f, 0);
    private Color color29 = decodeColor(base, 0.08801502f, -0.6317773f, 0.4470588f, 0);
    private Color color30 = decodeColor(base, 0.032459438f, -0.6113241f, 0.41568625f, 0);
    private Color color31 = decodeColor(base, 0.032459438f, -0.5985242f, 0.39999998f, 0);
    private Color color32 = decodeColor(base, 0.0f, -0.6357143f, 0.45098037f, 0);
    private Color color33 = decodeColor(base, 0.0013483167f, -0.1769987f, -0.12156865f, 0);
    private Color color34 = decodeColor(base, 0.059279382f, 0.3642857f, -0.43529415f, 0);
    private Color color35 = decodeColor(base, 0.004681647f, -0.6198413f, 0.43921566f, 0);
    private Color color36 = decodeColor(base, -8.738637E-4f, -0.50527954f, 0.35294116f, 0);
    private Color color37 = decodeColor(base, 5.1498413E-4f, -0.4555341f, 0.3215686f, 0);
    private Color color38 = decodeColor(base, 5.1498413E-4f, -0.4757143f, 0.43137252f, 0);
    private Color color39 = decodeColor(base, 0.08801502f, 0.3642857f, -0.52156866f, 0);
    private Color color40 = decodeColor(base, 0.032459438f, -0.5246032f, -0.12549022f, 0);
    //
    private Color color41 = decodeColor(base, 0.027408898f, -0.6847884f, 0.4980392f, 0);
    private Color color42 = decodeColor(base, 0.026611507f, -0.63623784f, 0.39999999f, 0);
    private Color color43 = decodeColor(base, 0.029681683f, -0.62701867f, 0.37254901f, 0);
    private Color color44 = decodeColor(base, 0.03801495f, -0.6456242f, 0.4215686f, 0);
    //
    private Color color45 = decodeColor(base, -0.57865167f, -0.6357143f, -0.54901963f, 0);
    private Color color46 = decodeColor(base, -3.528595E-5f, 0.018606722f, -0.23137257f, 0);
    private Color color47 = decodeColor(base, -4.2033195E-4f, -0.38050595f, 0.20392156f, 0);
    private Color color48 = decodeColor(base, 4.081726E-4f, -0.12922078f, 0.054901958f, 0);
    private Color color49 = decodeColor(base, 0.0f, -0.00895375f, 0.007843137f, 0);
    private Color color50 = decodeColor(base, -0.0015907288f, -0.1436508f, 0.19215685f, 0);
    ...
    public ExtComboBoxPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
    ...
    Color colorBack = new Color(0xFFFFFFF);

    private void paintBackgroundEnabled(Graphics2D g) {
        path = decodePath1();
        g.setPaint(color14); // Тень снизу?
        g.fill(path);
        path = decodePath2();
        g.setPaint(decodeGradient5(path)); // Обводка
        g.fill(path);
        path = decodePath3();
        g.setPaint(colorBack); //decodeGradient6(path)); // Фон надписи
        g.fill(path);
        path = decodePath4();
        g.setPaint(decodeGradient7(path)); // Обводка кнопки?
        g.fill(path);
        path = decodePath5();
        g.setPaint(decodeGradient8(path)); // Фон кнопки
        g.fill(path);
    }
    ...
    private void paintBackgroundFocused(Graphics2D g) {
        ...
        g.fill(path);
        path = decodePath3();
        g.setPaint(colorBack); //decodeGradient6(path));
        g.fill(path);
        path = decodePath4();
