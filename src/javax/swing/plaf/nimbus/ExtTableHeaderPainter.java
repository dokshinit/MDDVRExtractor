...
final class ExtTableHeaderPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor(baseColor, Color.WHITE, 0.9f); //decodeColor(base, 0.0057927966f, -0.51904764f, 0.35686274f, 0);
    private Color color2 = decodeColor(baseColor, Color.WHITE, 0.7f); //decodeColor(base, 0.0038565993f, -0.52012986f, 0.054901958f, 0);


    //Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public ExtTableHeaderPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
