...
final class ExtScrollBarThumbPainter extends AbstractRegionPainter {
    ...
    private Color color1 = decodeColor(base, 5.1498413E-4f, 0.18061227f, -0.35686278f, 0);
    private Color color2 = decodeColor(base, 5.1498413E-4f, -0.21018237f, -0.18039218f, 0);
    //
    private Color color3 = decodeColor(base, 0f, -0.53277314f, 0.25098038f, 0);
    private Color color4 = decodeColor(base, 0f, -0.6317617f, 0.44313723f, 0);
    private Color color5 = decodeColor(base, 0f, -0.44340658f, 0.26666665f, 0);
    private Color color6 = decodeColor(base, 0f, -0.4669379f, 0.38039213f, 0);
    private Color color7 = decodeColor(base, 0f, -0.56512606f, 0.45098037f, 0);
    //
    private Color color8 = decodeColor(base, -0.0017285943f, -0.362987f, 0.011764705f, 0);
    private Color color9 = decodeColor(base, 5.2034855E-5f, -0.41753247f, 0.09803921f, -222);
    private Color color10 = new Color(255, 200, 0, 255);
    private Color color11 = decodeColor(base, -0.0017285943f, -0.362987f, 0.011764705f, -255);
    private Color color12 = decodeColor(base, 0.010237217f, -0.5621849f, 0.25098038f, 0);
    private Color color13 = decodeColor(base, 0.08801502f, -0.6317773f, 0.4470588f, 0);
    private Color color14 = decodeColor(base, 5.1498413E-4f, -0.45950285f, 0.34117645f, 0);
    private Color color15 = decodeColor(base, -0.0017285943f, -0.48277313f, 0.45098037f, 0);
    private Color color16 = decodeColor(base, 0.0f, -0.6357143f, 0.45098037f, 0);
    private Color color17 = decodeColor(base, -0.57865167f, -0.6357143f, -0.54901963f, 0);
    private Color color18 = decodeColor(base, 0.0013483167f, 0.29021162f, -0.33725494f, 0);
    private Color color19 = decodeColor(base, 0.002908647f, -0.29012606f, -0.015686274f, 0);
    private Color color20 = decodeColor(base, -8.738637E-4f, -0.40612245f, 0.21960783f, 0);
    private Color color21 = decodeColor(base, 0.0f, -0.01765871f, 0.015686274f, 0);
    private Color color22 = decodeColor(base, 0.0f, -0.12714285f, 0.1372549f, 0);
    private Color color23 = decodeColor(base, 0.0018727183f, -0.23116884f, 0.31372547f, 0);
    private Color color24 = decodeColor(base, -8.738637E-4f, -0.3579365f, -0.33725494f, 0);
    private Color color25 = decodeColor(base, 0.004681647f, -0.3857143f, -0.36078435f, 0);
    //Array of current component colors, updated in each paint call
    private Object[] componentColors;

    public ExtScrollBarThumbPainter(PaintContext ctx, int state) {
        super();
        this.state = state;
        this.ctx = ctx;
    }
    ...
    private void paintBackgroundEnabled(Graphics2D g) {
        path = decodePath1(); // Обводка с полукруглой стороны.
        g.setPaint(decodeGradient1(path));
        g.fill(path);
        path = decodePath2(); // Фон.
        g.setPaint(decodeGradient2(path));
        g.fill(path);
        path = decodePath3(); // Тень на конце закругления.
        g.setPaint(decodeGradient3(path));
        g.fill(path);
        path = decodePath4(); // Х.з.
        g.setPaint(color10);
        g.fill(path);
        path = decodePath5(); // Освещение на конце закругления.
